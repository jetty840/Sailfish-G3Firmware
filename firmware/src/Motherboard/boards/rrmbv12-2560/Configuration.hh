...
//If defined, overrides UART to run at 38400 instead of 115200 (the default for the Mega)
#define OVERRIDE_UART_TO_38400_BAUD

//Stores the ram usage to eeprom everytime switchToRegularDriver is called
//You don't want to leave this enabled as it can cause excessive eeprom write
//#define STORE_RAM_USAGE_TO_EEPROM
